...
export const TEXT_CONTENT: Record<Language, ContentText> = {
  [Language.ENGLISH]: {
    ...
    navEvents: "Events",
    navContact: "Contact",
    heroTitle: "Language Exchange of Valencia",
    ...
    aboutTitle: "What is LEV?",
    aboutText: "LEV is a language exchange curated by students from ACIL in Valencia. Its mission is to UNITE and help the Valencian community practice their language skills and meet new people. All levels of proficiency are accepted!",
    ...
    detailsWhere: "1st. C. Carcagente, 2, Jesús, 46007 València, Valencia",
    detailsWhere2: "2nd. C. Carcagente, 2, Jesús, 46007 València, Valencia",
    detailsWhere3: "3rd. C. Carcagente, 2, Jesús, 46007 València, Valencia",
    ...
    aiButton: "New Idea",
    footerRights: "© 2025 LEV - Language Exchange of Valencia. All rights reserved.",
  ...
  [Language.SPANISH]: {
    ...
    heroSubtitle: "Únete a nuestro LEV de idiomas inglés-español. ¡Practica tus habilidades para hablar en un ambiente relajado y amigable!",
    ctaButton: "Unirse la próxima reunión",
    feedbackButton: "Danos tu opinión",
    aboutTitle: "¿Qué es LEV?",
    aboutText: "LEV es un programa de intercambio de idiomas organizado por estudiantes de ACIL en Valencia. Su misión es unir y ayudar a la comunidad valenciana a practicar sus habilidades lingüísticas y conocer gente nueva. ¡Se aceptan todos los niveles!",
    ...
    detailsWhere: "1.ª C. Carcagente, 2, Jesús, 46007 València, Valencia",
    detailsWhere2: "2.ª C. Carcagente, 2, Jesús, 46007 València, Valencia",
    detailsWhere3: "3.ª C. Carcagente, 2, Jesús, 46007 València, Valencia",
    ...
    aiButton: "Nueva Idea",
    footerRights: "© 2025 LEV - Language Exchange de Valencia. Todos los derechos reservados.",
