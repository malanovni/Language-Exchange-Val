    ...
    <footer id="footer" className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex space-x-6">
          <a href="mailto:chloe.jasinski@acil.education" className="text-slate-400 hover:text-brand-500 transition-colors text-sm font-medium">
            chloe.jasinski@acil.education
          </a>
        </div>
      </div>
    </footer>
